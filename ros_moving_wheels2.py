...
class MotorDriver:
    ...
    def twist_callback(self,data):
        ...
        if wheel_vel_L > 1.7:
            wheel_vel_L = 1.7
        elif wheel_vel_L < -1.7:
            wheel_vel_L = -1.7

        if wheel_vel_R > 1.7:
            wheel_vel_R = 1.7
        elif wheel_vel_R < -1.7:
            wheel_vel_R = -1.7
...
def listener():
    ...
    #one wheel at a time
    #motor_driver.wheelVeltoSerial(TEST_ANGULAR_VELOCITY, "right")
    #motor_driver.wheelVeltoSerial(TEST_ANGULAR_VELOCITY, "left")
    #sleep(2)
    #motor_driver.wheelVeltoSerial(0, "right")
    #motor_driver.wheelVeltoSerial(0, "left")
